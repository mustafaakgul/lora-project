...
/******** -0- *************************/
#define SWITCH_1_PORT    PORTBbits.RB0
#define SWITCH_1_LAT     LATBbits.LATB0
#define SWITCH_1_TRIS    TRISBbits.TRISB0
#define SWITCH_1_IOC     IOCBbits.IOCB0
/******** -1- *************************/
#define SWITCH_2_PORT    PORTBbits.RB1
#define SWITCH_2_LAT     LATBbits.LATB1
#define SWITCH_2_TRIS    TRISBbits.TRISB1
#define SWITCH_2_IOC     IOCBbits.IOCB1
